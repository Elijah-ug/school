  ...
  return (
    <div className="flex p-6 items-center justify-center mt-10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl w-full">
        <div className="abt bg-gray-600 shadow-2xl rounded-2xl p-6 text-white hover:text-gray-900 hover:bg-gray-300">
        <h2 className="text-xl font-bold  mb-4">About Us</h2>
          <p className="leading-relaxed">
            Nyakabandde Secondary School is a community-based government-aided school located
        ...
        <div className="mission bg-gray-600 shadow-2xl rounded-2xl p-6 text-white hover:text-gray-900 hover:bg-gray-300">
        ...
        <div className="vision bg-gray-600 shadow-2xl rounded-2xl p-6 text-white hover:text-gray-900 hover:bg-gray-300">
        ...
        <div className="values bg-gray-600 shadow-2xl rounded-2xl p-6 text-white hover:text-gray-900 hover:bg-gray-300">
        ...
        <div className="facilitis bg-gray-600 shadow-2xl rounded-2xl p-6 text-white hover:text-gray-900 hover:bg-gray-300">
        ...
        <div className="contact bg-gray-600 shadow-2xl rounded-2xl p-6 text-white hover:text-gray-900 hover:bg-gray-300">
        <h2 className="text-xl font-bold  mb-4">Contact Us</h2>
          <p>
              <strong>Location:</strong> Nyakabandde, Kisoro District, Uganda <br />
              <strong>Phone:</strong> +256 782 123456 <br />
              <strong>Email:</strong> info@nyakabanddesecondary.ac.ug
          </p>
        </div>
      </div>
    </div>
