...
export const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white py-8 px-6 md:px-16 lg:px-24 flex flex-col gp-7 text-sm mt-14 ">
      {/* mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 */}
      <div className="mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-1 text-gray-300">
            <li>
              <Link to="academics" className="hover:text-gray-100">
                Academics
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="academics/academic-departments" className="hover:text-gray-100">
                Our Academics
              </Link>
            </li>
            <li>
              <Link to="contacts" className="hover:text-gray-100">
                Contact Us
              </Link>
            </li>
          </ul>
